...
internal class ROS2ForUnity
{
    ...
    private void LoadMetadata() 
    {
        ...
        try
        {   
            Debug.Log(GetRos2ForUnityPath() + separator + "metadata_ros2cs.xml");
            Debug.Log(GetRos2ForUnityPath() + separator + "metadata_ros2_for_unity.xml");
            ros2csMetadata.Load(GetRos2ForUnityPath() + separator + "metadata_ros2cs.xml");
